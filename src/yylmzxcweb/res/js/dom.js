...
(function (Nav) {
  ...
  // 把本地文件读成 data URL：属于浏览器副作用，收在此层，
  // 使接口层（api）只面对「字符串 → 请求」，不碰 FileReader。
  ...
  Nav.dom = {
    el: el, svg: svg, toast: toast, download: download, pickFile: pickFile, readAsDataURL: readAsDataURL
  };
})(window.Nav);
