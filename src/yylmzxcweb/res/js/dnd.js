...
(function (Nav) {
  ...
  function setup(handlers) {
    ...
    wrap.addEventListener('dragstart', function (e) {
      ...
      if (linkEl) {
        state.drag = { type: 'link', gid: linkEl.dataset.gid, lid: linkEl.dataset.lid };
      ...
      if (card) {
        state.drag = { type: 'group', gid: card.dataset.gid };
    ...
    wrap.addEventListener('drop', function (e) {
      ...
      if (drag.type === 'group') {
        var toIdx = store.state.data.groups.map(function (g) { return g.id; }).indexOf(toGid);
