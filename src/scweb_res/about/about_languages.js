...
const AboutLanguageConfig = {
    ...
    translations: {
        zh: {
            ...
            about: {
                title: '关于生存战争网',
                whatIs: '什么是生存战争网？',
                whatIsDesc: '生存战争网 (scnet.top)，Survivalcraft 中文导航聚合站点。汇集国内与海外社区、Wiki 文档、模组网站、启动器、服务器列表、API 开发资源，一站式导航，方便生存战争玩家快速查找各类社区、教程与工具链接。',
                features: '我们提供什么？',
                feature1: '国内外生存战争社区与Wiki导航聚合',
                feature2: '联机服务器列表与状态检测',
                feature3: '实用在线工具（模型读取器、Mod开发工具包）',
        ...
        en: {
            ...
            about: {
                ...
                feature1: 'Domestic & overseas SurvivalCraft community & Wiki navigation',
                feature2: 'Multiplayer server list with status detection',
                feature3: 'Online tools (Mesh Reader, Mod Dev Kit)',
        ...
        ru: {
            ...
            about: {
                ...
                feature1: 'Навигация по сообществам и Wiki SurvivalCraft',
                feature2: 'Список серверов с проверкой статуса',
                feature3: 'Онлайн-инструменты (чтение Meshes, набор для разработки модов)',
        ...
        es: {
            ...
            about: {
                ...
                feature1: 'Navegación por comunidades y Wiki de SurvivalCraft',
                feature2: 'Lista de servidores con detección de estado',
                feature3: 'Herramientas en línea (Lector de Meshes, Kit de Desarrollo de Mods)',
    ...
    navigation: {
        ...
        other: [
            ...
            { title: 'links.yylmzxcNav', url: 'yylmzxcweb/yylmzxc.html', external: false },
